...
// This smoke drives the external CLI (dist/cli.js) through
// topology-smoke-helper.js: dispatchAndOutput() (helper lines 57/59) calls
//   cw worker manifest <run> <worker>
//   cw worker output   <run> <worker> <result>
// and every worker subcommand (list/summary/show/manifest/output/fail/
// validate) must have a real CLI path binding, not fall through to the
// usage error.
