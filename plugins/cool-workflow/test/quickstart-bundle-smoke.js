...
// Facade shims mapping the old runner-based call sites onto v2's free functions.
function makeRunner() {
...
function drive(runner, runId, options) { return driveRun(runId, runner._cwd(), options); }
