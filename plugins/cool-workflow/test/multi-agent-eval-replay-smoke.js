...
(async () => {
  ...
  // dist/mcp-server.js. `blackboard message post <run-id>` (and the
  // sibling 3-token blackboard verbs — topic.create, artifact.add/.list,
  // context.put) must resolve the run id correctly.
