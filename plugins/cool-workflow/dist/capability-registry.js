...
const BUILTIN_CAPABILITIES = [
    ...
    // ---- Cross-agent handoff ledger (stage 1, human-relay transport) --------
    { capability: "ledger.propose", summary: "Build a verifiable cross-agent change proposal entry (printed as JSON).", entry: "buildLedgerProposal", surface: "cli-only", cli: { path: ["ledger", "propose"], caseTokens: ["ledger", "propose"], jsonMode: "default" }, reason: "Stage 1 human-relay MVP: emits a self-contained, digest-sealed entry to stdout for the operator to carry to the other session. The MCP surface + git-ledger transport land in a later cycle." },
    { capability: "ledger.review", summary: "Build a verifiable cross-agent review verdict entry (printed as JSON).", entry: "buildLedgerReview", surface: "cli-only", cli: { path: ["ledger", "review"], caseTokens: ["ledger", "review"], jsonMode: "default" }, reason: "Stage 1 human-relay MVP: emits a self-contained, digest-sealed verdict to stdout. The MCP surface + git-ledger transport land in a later cycle." },
    { capability: "ledger.verify", summary: "Verify a ledger entry against its content digest (fail-closed on tampering).", entry: "verifyLedgerEntry", surface: "cli-only", cli: { path: ["ledger", "verify"], caseTokens: ["ledger", "verify"], jsonMode: "default" }, reason: "Stage 1 human-relay MVP: reads an entry from --file/stdin and refuses a tampered or malformed one with a non-zero exit. The MCP surface lands with the git-ledger transport in a later cycle." }
];
