...
// The schedule/routine/sched verbs are dispatched into their own handler
// (src/shell/registry-cli.ts) — each bare verb fails closed with its carved handler's usage string.
