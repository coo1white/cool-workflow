...
Thank you for your interest in contributing to this project ("the Project"). This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Project.
...
- **"Project Owner"** means the natural person or legal entity that, at the time of Your Contribution, has control of the account which owns the source code repository in which this Agreement is published (control of that account being proof of identity for the purposes of this Agreement), or any individual or legal entity to whom that person or entity has explicitly assigned or transferred ownership of the Project in writing, and their respective successors and assigns.
...
**Notification.** Notices under this Agreement shall be sent to the Project Owner via an issue on the Project repository. Notices are effective upon receipt.
