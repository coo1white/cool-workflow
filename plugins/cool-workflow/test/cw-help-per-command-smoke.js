...
//
// `cw help commit` lists `cw commit summary`; `cw help worker` lists
// worker list/show/manifest/output/fail/validate/summary — each verb's
// registry subcommands, not just the verb itself.
