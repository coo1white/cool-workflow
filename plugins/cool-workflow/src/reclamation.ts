...
import { contentDigest, dirBytes, sha256OfFile, sha256OfString } from "./reclamation/hash";
...
// Content addressing + byte measurement (sha256OfString/sha256OfFile/dirBytes/
// contentDigest) now live in ./reclamation/hash — pure leaf helpers carved out of
// this transaction module. Re-exported here so the public surface is unchanged.
export { sha256OfString, sha256OfFile, dirBytes };
