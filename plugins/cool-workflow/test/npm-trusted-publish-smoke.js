...
assert.match(workflow, /npm install -g npm@11\.5\.1\b/, "npm-publish must install npm with Trusted Publishing support, pinned to an EXACT version (no ^ range) since this job holds the OIDC token");
