...
assert.equal(summary.candidateId, "dogfood-release-0.1.79");
...
assert.equal(state.inputs.version, "0.1.79");
...
// v0.1.79: the architecture-review agent-delegation dogfood, --smoke half (CI-
