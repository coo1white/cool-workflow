...
description: Independent release reviewer for cool-workflow. MUST be invoked before any git tag is created. Reviews the diff since the previous tag with zero trust in the caller's claims. Use proactively when a release is being prepared.
