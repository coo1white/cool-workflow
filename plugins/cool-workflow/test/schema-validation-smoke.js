...
// validateResultEnvelope (dist/shell/verifier.js) enforces task.schema
// against the accepted result, after the evidence/finding checks, and
// throws "…violates declared schema…" (fail-closed => the drive parks the
// hop) on a violation.
...
function main() {
  ...
  // Four gate cases: a conforming result passes; enum/required/item-type
  // violations each throw "violates declared schema"; a task with no
