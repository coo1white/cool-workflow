...
//
// LOAD-BEARING LAYOUT (PLAN.md (project/docs/rebuild) byte-compat item 14 — do not "clean up"):
...
// PLAN.md (project/docs/rebuild) milestone 2's own "done when": a CLI `--help` walk and an MCP
