...
// This smoke is pure CLI/MCP black-box — it only spawns dist/cli.js and
// dist/mcp-server.js. The multi-word multi-agent option flags
// (--required-evidence, --sandbox-profile-hint, --expected-artifact,
// --fanin-obligation, --required-role) must reach
// src/shell/multi-agent-cli.ts and populate role.requiredEvidence and the
// fanin's required roles, not fold to [].
