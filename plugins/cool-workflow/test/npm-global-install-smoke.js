...
function main() {
  ...
  //
  // Black-box: drives the installed `cw` bin as a subprocess. From a global
  // install with an unrelated cwd, `cw -q --check` must still resolve the
  // bundled app (src/shell/workflow-app-loader.ts) — the "install once, use
  // anywhere" property this smoke proves.
