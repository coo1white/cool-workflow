...
Generated from the current repository code on 2026-09-08 by `npm run sync:project-index`.
...
- [agent-muse-native-smoke.js](../test/agent-muse-native-smoke.js)
...
- [ci-shape-gate-smoke.js](../test/ci-shape-gate-smoke.js)
- [citation-check-smoke.js](../test/citation-check-smoke.js)
...
- [css-framework-gate-smoke.js](../test/css-framework-gate-smoke.js)
...
- [dist-drift-check-smoke.js](../test/dist-drift-check-smoke.js)
...
- [enforcement-labels-smoke.js](../test/enforcement-labels-smoke.js)
...
- [gc-reclamation-state-lock-smoke.js](../test/gc-reclamation-state-lock-smoke.js)
...
- [growth-budget-check-smoke.js](../test/growth-budget-check-smoke.js)
...
- [package-manager-gate-smoke.js](../test/package-manager-gate-smoke.js)
...
- [registry-refresh-no-double-scan-smoke.js](../test/registry-refresh-no-double-scan-smoke.js)
...
- [shell-backend-structural-smoke.js](../test/shell-backend-structural-smoke.js)
- [sigint-sigterm-drive-loop-smoke.js](../test/sigint-sigterm-drive-loop-smoke.js)
- [site-snapshot-smoke.js](../test/site-snapshot-smoke.js)
...
- [source-context-external-repo-smoke.js](../test/source-context-external-repo-smoke.js)
- [source-context-glob-smoke.js](../test/source-context-glob-smoke.js)
- [source-context-onramp-smoke.js](../test/source-context-onramp-smoke.js)
...
- [verdict-prior-findings-smoke.js](../test/verdict-prior-findings-smoke.js)
