...
// `topology apply <run> map-reduce --id topo-map` must honor the
// caller-supplied id so derived ids (topo-map-fanout, topo-map-group,
// topo-map-mapper-N) are stable and referenceable by the later
// fanin/dispatch/coordinator steps.
