...
export function reportToHtml(markdown: string, title = "Report"): string {
  ...
  return (
    `<!doctype html><html lang="en" dir="ltr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#0d1117"><title>${escapeHtml(title)}</title><style>${REPORT_CSS}</style></head>` +
