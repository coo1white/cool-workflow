...
For the curated version of these findings, in the structure a published audit should
follow, see
[`examples/audits/self-audit-cool-workflow-v0.1.42.md`](../../examples/audits/self-audit-cool-workflow-v0.1.42.md)
— a historical snapshot; its citations predate the core/shell `src/` split and no
longer resolve against the current tree.
