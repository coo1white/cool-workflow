...
// dist/mcp-server.js. It drives the "Multi-Agent Operator UX" family
// (v0.1.21 + v0.1.27): `cw multi-agent status` (no --json) renders the
// Agent Graph panel, and `cw multi-agent dependencies|failures|evidence`
// carry real CLI bindings alongside summary/graph.
