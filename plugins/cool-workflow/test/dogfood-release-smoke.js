...
assert.equal(summary.candidateId, "dogfood-release-0.1.83");
...
assert.equal(state.inputs.version, "0.1.83");
...
// v0.1.83: the architecture-review agent-delegation dogfood, --smoke half (CI-
