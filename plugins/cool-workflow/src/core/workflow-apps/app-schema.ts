...
//
// MILESTONE 12 (project/docs/rebuild/PLAN.md build order; workflow-apps.md). Milestone 6+7
...
// from the old build's workflow-app-framework module. `WorkflowAppDefinition` is the
