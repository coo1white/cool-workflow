...
| [`AGENTS.md`](https://github.com/coo1white/cool-workflow/blob/main/AGENTS.md) / [`CLAUDE.md`](https://github.com/coo1white/cool-workflow/blob/main/CLAUDE.md) | The binding rules for coding agents working ON this repo; `AGENTS.md` is the one source of truth (also carries product direction/moat and build-memory content merged in from the former `DIRECTION.md`) |
