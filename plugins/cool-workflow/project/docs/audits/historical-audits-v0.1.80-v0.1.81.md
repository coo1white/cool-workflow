# Historical audits at v0.1.80 and v0.1.81

Two audit records from CW's own runs against this repository, kept word
for word. Findings here may be fixed by now. They were two files until
2026-09-02; they are one file now so the .md count stays inside the growth
budget.

---

## FreeBSD philosophy audit at v0.1.80
