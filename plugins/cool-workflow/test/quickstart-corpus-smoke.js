...
try {
  ...
  // The report renderer (src/shell/report.ts) gates the label on
  // workflowApp?.metadata?.domain === "research", which the
  // research-synthesis app's manifest (apps/research-synthesis/app.json)
  // sets; code apps keep "Repository:".
