import type { WorkerIsolationOptions, WorkerScope, WorkflowRun } from "../types";
import { sha256 } from "../execution-backend";
import { verifyTelemetryAttestation, resolveTrustPublicKey } from "../telemetry-attestation";
...
export interface WorkerTelemetryDeps {
  recordWorkerFailure(
    run: WorkflowRun,
    workerId: string,
    error: unknown,
...
export function attestWorkerDelegation(accept: WorkerAcceptContext, deps: WorkerTelemetryDeps): WorkerDelegation {
