...
// not touched again — see docs/rebuild/PLAN.md's Revision note.
//
// The pure data (types, the MCP_TOOL_DATA transcript, and the dependency-
// free helpers that only touch it) lives in core/capability-data.ts —
// re-exported below so every existing external import site (cli/dispatch.ts,
// mcp/dispatch.ts, the captable-*.test.js unit tests) keeps working
// unchanged.
const capability_data_1 = require("./capability-data");
