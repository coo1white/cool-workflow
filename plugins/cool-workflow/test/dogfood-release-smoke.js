...
assert.equal(summary.candidateId, "dogfood-release-0.1.81");
...
assert.equal(state.inputs.version, "0.1.81");
...
// v0.1.81: the architecture-review agent-delegation dogfood, --smoke half (CI-
