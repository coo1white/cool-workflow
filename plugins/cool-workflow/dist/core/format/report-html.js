...
function reportToHtml(markdown, title = "Report") {
    ...
    return (`<!doctype html><html lang="en" dir="ltr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#0d1117"><title>${escapeHtml(title)}</title><style>${report_css_1.REPORT_CSS}</style></head>` +
