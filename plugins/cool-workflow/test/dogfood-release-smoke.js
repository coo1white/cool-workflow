...
assert.equal(summary.candidateId, "dogfood-release-0.1.78");
...
assert.equal(state.inputs.version, "0.1.78");
...
// v0.1.78: the architecture-review agent-delegation dogfood, --smoke half (CI-
