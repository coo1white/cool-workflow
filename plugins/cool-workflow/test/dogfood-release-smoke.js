...
assert.equal(summary.candidateId, "dogfood-release-0.1.76");
...
assert.equal(state.workflow.app.version, "0.1.76");
assert.equal(state.inputs.repo, repoRoot);
assert.equal(state.inputs.version, "0.1.76");
...
// v0.1.76: the architecture-review agent-delegation dogfood, --smoke half (CI-
