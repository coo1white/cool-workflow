...
| [`AGENTS.md`](AGENTS.md) / [`CLAUDE.md`](CLAUDE.md) | The binding rules for coding agents working ON this repo; `AGENTS.md` is the one source of truth (also carries product direction/moat and build-memory content merged in from the former `DIRECTION.md`) |
