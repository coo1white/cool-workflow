...
assert.equal(summary.candidateId, "dogfood-release-0.1.82");
...
assert.equal(state.inputs.version, "0.1.82");
...
// v0.1.82: the architecture-review agent-delegation dogfood, --smoke half (CI-
