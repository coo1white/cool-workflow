...
// live in core/hash.ts (the one hash module, per PLAN.md (project/docs/rebuild)'s byte-compat
...
// parity (PLAN.md (project/docs/rebuild) byte-compat item 3, Open risk 2). See
 ...
 *  collapse status set (PLAN.md (project/docs/rebuild) byte-compat item 9). */
