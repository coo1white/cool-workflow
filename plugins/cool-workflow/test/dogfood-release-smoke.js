...
assert.equal(summary.candidateId, "dogfood-release-0.1.80");
...
assert.equal(state.inputs.version, "0.1.80");
...
// v0.1.80: the architecture-review agent-delegation dogfood, --smoke half (CI-
