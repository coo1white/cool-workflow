...
function main() {
  ...
  try {
    ...
    assert.equal(appValidation.summary.version, "0.1.47");
    ...
    const plan = runJson(
      [
        ...
        tmp,
        "--question",
        "Prove the deterministic v0.1.47 end-to-end golden path."
      ],
      pluginRoot
    );
    ...
    assert.match(report, /Workflow App: end-to-end-golden-path@0\.1\.47/);
