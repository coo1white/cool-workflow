...
// maybeExpandLoop" (src/orchestrator/lifecycle-operations.ts:490-604).
...
// "interpret", loopRound set, and all run-specific fields cleared.
{
  ...
  assert.equal(cloned.phase, "map", "phase/kind/prompt fields NOT explicitly reset must survive the clone");
